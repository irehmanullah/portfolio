...
export const metadata = {
  title: "Rehman Ullah - Articles",
  description:
    "Browse through Rehman Ullah's collection of software engineering articles and tutorials on Next.js, React.js, web development, and more.  Gain valuable insights and stay up-to-date with SEO tips for building a developer portfolio.",
};
